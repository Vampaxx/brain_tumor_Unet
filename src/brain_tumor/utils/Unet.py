...
from tensorflow.keras.layers import (Input,Activation, BatchNormalization,
                                    Dropout, Lambda, Conv2D, Conv2DTranspose,
                                    MaxPooling2D, concatenate,Conv2D)



def unet(input_size:list):
    ...
    up6   = concatenate([Conv2DTranspose(256, kernel_size=(2, 2), strides=(2, 2), padding="same")(bn5),conv4],axis=3)
    ...
    up7   = concatenate([Conv2DTranspose(128, kernel_size=(2, 2), strides=(2, 2), padding="same")(bn6),conv3],axis=3)
    ...
    up8   = concatenate([Conv2DTranspose(64, kernel_size=(2, 2), strides=(2, 2), padding="same")(bn7),conv2],axis=3)
    ...
    up9   = concatenate([Conv2DTranspose(32, kernel_size=(2, 2), strides=(2, 2), padding="same")(bn8),conv1],axis=3)
